...
using GunDetectML.Model;
using Microsoft.ML.Vision;

namespace GunDetectML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\AndreyUser\AppData\Local\Temp\c1e14ef0-9729-40d0-af7a-d477c8268d9b.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\AndreyUser\AppData\Local\Temp\MLVSTools\GunDetectML\GunDetectML.Model\MLModel.zip";
